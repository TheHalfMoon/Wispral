...
All six applicable push workflows on canonical merge `83eca872148f329033c299f6671d275edf2d7b58` completed successfully. `000B2 Public Corpus Subset Selection` run `33775647508`, job `100716549752`, checked out the exact merge and passed deterministic selector plus mutation-adversarial verification. `000B2 Public Corpus Methodology` run `33775647539`, job `100716550502`, also passed on the exact merge. `000B2 Trusted Materialization Authority` run `33775647532`, `000B2 Trusted Participant Materials` run `33775647580`, `000B2 Trusted Participant Policy` run `33775647607`, and `000B2 Trusted Human Authority Structure` run `33775647617` also succeeded. No selected-subset manifest was frozen, `candidate_decoding_started=false`, `primary_decoding_started=false`, no production STT was selected, no product code was authorized, and no human developer-speech accuracy evidence was created. The canonical authority/readiness reread therefore completes B2P03 and authorized B2P04 only.

PR #39 then completed B2P04 deterministic public-human source-membership freeze and merged by guarded expected-head squash as canonical commit `4c4e758f22b54fa62256e57bfbd344adc817df8e` from exact qualified head `0d83d277cc2544f63613e674d60bae07ad24dc26` against exact base `c1a576db2adf67cb4b830c280e6cba80b0ae3b43`. The final candidate changed exactly five files. Exact-head `000B2 Public Corpus Methodology` run `33793696076` and `000B2 Public Corpus Subset Freeze` run `33793696006`, job `100776173700`, completed successfully. The subset-freeze gate used pinned Python `3.12`, passed offline adversarial and exact root-metadata regression verification, re-fetched the official OpenSLR archives, regenerated the committed manifest byte-for-byte, and preserved `candidate_revalidation_started=false`, `candidate_decoding_started=false`, and `primary_decoding_started=false`. Fresh independent CodeRabbit semantic audit comment `5530776500` covered exact base `c1a576db2adf67cb4b830c280e6cba80b0ae3b43` through exact head `0d83d277cc2544f63613e674d60bae07ad24dc26` and all five changed files and reported no actionable findings. The only substantive inline review thread had been repaired forward-only and resolved before merge. The merge is GitHub-signature verified with parent equal to the qualified base.

All six applicable push workflows on canonical merge `4c4e758f22b54fa62256e57bfbd344adc817df8e` completed successfully. `000B2 Public Corpus Subset Freeze` run `33794854765`, job `100779961908`, checked out the exact canonical merge, used pinned Python `3.12`, passed exact revision identity, offline freeze-boundary and exact root-metadata verification, reproduced the committed B2P04 manifest, and uploaded artifact `9908811632` with ZIP digest `sha256:bad9a31cea1a3a51b6ecbf9053f4941b1ae8a5d88cb97b747703166fe9444578`. `000B2 Public Corpus Methodology` run `33794854595`, job `100779960182`, also succeeded on the exact merge. `000B2 Trusted Materialization Authority` run `33794854462`, `000B2 Trusted Participant Materials` run `33794854484`, `000B2 Trusted Participant Policy` run `33794854642`, and `000B2 Trusted Human Authority Structure` run `33794854865` also succeeded. The frozen manifest byte SHA-256 is `5fa108dc623760f194fdde463cbfb819288fe8f2a10279d25ec889f221b389bb` and its self-excluding freeze digest is `f75a1084e8414e56a47b00350d5a7c1295445e2c52b03a0f591c40c041c9f242` for 24 speakers and 240 utterances. Candidate revalidation and all decoding remained unstarted; B2P06 preprocessing identities were not captured; no production STT was selected; no product code was authorized; and `HUMAN_DEVELOPER_SPEECH_ACCURACY_EVIDENCE=ABSENT` remained preserved. The canonical authority/readiness reread therefore completes B2P04 and authorizes B2P05 only.

PR #41 then completed B2P05 candidate identity revalidation and merged by guarded expected-head squash as canonical commit `49538990fb4cf8223e9321261925206ed7ff5cee` from exact qualified head `c62a7fa2998cd5292da78a66deb4a6d2044691b3` against exact base `6135cd67c1b31e0be0b82ba202b6a6770d34b68d`. The final candidate changed exactly three files. Exact-head `000B2 Public Corpus Candidate Revalidation` run `33802435769` and `000B2 Public Corpus Methodology` run `33802435851` completed successfully after forward-only repair of exact-head checkout, canonical-base authority separation, and the public-readiness `execution_environment` schema key. Fresh independent CodeRabbit semantic review covered exact base `6135cd67c1b31e0be0b82ba202b6a6770d34b68d` through exact head `c62a7fa2998cd5292da78a66deb4a6d2044691b3`, all three changed files, and reported no actionable findings. Zero actionable review threads remained before merge. The merge is GitHub-signature verified with parent equal to the qualified base.

All six applicable push workflows on canonical merge `49538990fb4cf8223e9321261925206ed7ff5cee` completed successfully. `000B2 Public Corpus Candidate Revalidation` run `33803832655` checked out the independent canonical base and exact canonical candidate revision; static job `100809416957` passed exact trust-boundary, canonical authority, six-cell membership, C0-context, and later-gate checks; live job `100809480949` reproduced all 18 pending artifact identities from canonical trusted authority and revalidated runtime releases/revisions plus all pre-pinned model identities. `000B2 Public Corpus Methodology` run `33803832693`, job `100809418067`, also succeeded on the exact merge. `000B2 Trusted Materialization Authority` run `33803832706`, `000B2 Trusted Participant Materials` run `33803832711`, `000B2 Trusted Participant Policy` run `33803832717`, and `000B2 Trusted Human Authority Structure` run `33803832657` also succeeded. Candidate decoding and primary decoding remained unstarted; B2P06 preprocessing capture, B2P07 environment capture, and B2P08 attempt freeze remained unresolved/unstarted; no production STT was selected; no product code was authorized; and `HUMAN_DEVELOPER_SPEECH_ACCURACY_EVIDENCE=ABSENT` remained preserved. The canonical authority/readiness reread therefore completes B2P05 and authorizes B2P06 only.
...
PR #45 then completed B2P07 attempt-bound execution-environment capture and merged by guarded expected-head merge commit as canonical commit `4bd5306fa1d274d7b822b73e26172dd9c7058319` from exact qualified head `422ea2d7f0945437ea271412b2f2e33c85256f2e` against exact base `a45e69f3f03094c947104438ac1f0b2aa124b295`. Exact-head environment run `33863710225` and methodology run `33863710318` succeeded. Fresh independent CodeRabbit substantive semantic review covered the complete final four-file diff and explicitly reported no actionable semantic findings after forward-only repair of historical capture-blob and GitHub job/artifact provenance binding. Zero actionable review threads remained before merge. The merge commit preserved exact old-main and B2P07 head ancestry, which is required by the durable verifier.

Canonical post-merge environment run `33864082394`, job `100994833527`, checked out exact merge `4bd5306fa1d274d7b822b73e26172dd9c7058319` with full history and reverified raw capture commit `aa4711c083b652dfdb7a5d29a39a222125000131` / blob `d84e3e55d45a937a09e5898727b60c635144ac5c`, provenance-seal commit `b8268cb4316a0d05c898bbf5b8bb3f7fe82d4937` / blob `caf814bcb5e42fd769e6df1d9a54c1164535f86c`, capture run `33859864538`, job `100981596254`, artifact `9931671160`, and artifact ZIP digest `sha256:ff527e3864159bdfb2199047306a0ead6387a5cc1b7748acc1de946753d77d9b`. It emitted `B2P07_ENVIRONMENT_VERIFIER=PASS`, `B2P07_PERFORMANCE_MODE=DIAGNOSTIC`, `B2P07_COMPARATIVE_PERFORMANCE_AUTHORIZED=NO`, `B2P08_ATTEMPT_MANIFEST_FROZEN=NO`, and `CANDIDATE_DECODING_STARTED=NO`. Methodology run `33864082358`, job `100994833254`, candidate-revalidation run `33864082439`, trusted-materialization run `33864082418`, participant-materials run `33864082356`, participant-policy run `33864082410`, and human-authority run `33864082452` also succeeded on the same canonical merge. The canonical authority/readiness reread therefore completes B2P07 and authorizes B2P08 only; no candidate or primary decoding is authorized by this reconciliation.
...
- canonical B2P04 source-membership manifest freeze at PR #39 merge `4c4e758f22b54fa62256e57bfbd344adc817df8e`, including manifest byte SHA-256 `5fa108dc623760f194fdde463cbfb819288fe8f2a10279d25ec889f221b389bb`, freeze digest `f75a1084e8414e56a47b00350d5a7c1295445e2c52b03a0f591c40c041c9f242`, and successful six-lane canonical post-merge verification;
...
- B2R01 is canonical at merge `715efc4855fb52187ed250b11f0c28bb2c2c0660`, exact-merge-head recovery run `33979925715` succeeded; B2R02 is canonical and post-merge verified at task merge `8dc723efff01fd4461688962a2891bf9e8841f4d` with recovery run `33991218657`; B2R03 is canonical and post-merge verified at task merge `6904fa7dd55e35c08e76044a18ebf9a95c65e038` with recovery run `33995766496`; B2R04 is canonical and post-merge verified at task merge `cdf8e4c13a1e17fe5e0db7bc360e5fbbeef496e0` with recovery run `33998872408`; ATTEMPT-002 was frozen with freeze digest `600a286747ef2e1503a48c4138b6e405665ccd6586904ef65b3638b49974bcc8`; B2R05 through B2R09 remain canonical historical ATTEMPT-002 evidence, with B2R09 task merge `fc357350270d5cb34fc1305dba4a9de41a5234c3` and recovery run `34160146607`; B2R10 was the sole open recovery/primary-decode entry only at that superseded ATTEMPT-002 frontier. ATTEMPT-002 is now invalidated for material execution drift and grants no present execution authority. At that historical pre-B2R15-reconciliation frontier, recovery authority was ATTEMPT-003 B2R15 only; ATTEMPT-003 was unfrozen, primary decoding and scoring were closed, and B2R16+ were unauthorized. That frontier is superseded by the canonical B2R16 reconciliation below; current recovery authority is ATTEMPT-003 B2R17 only, with ATTEMPT-003 frozen, primary decode entry open only for B2R17, and scoring closed.

## Historical B2R01 recovery reconciliation — superseded predecessor record

This B2R01 block is retained only as transition chronology and is **not current execution authority**. The later B2R09 block below is also historical/superseded ATTEMPT-002 chronology; the later ATTEMPT-003 B2R14 corrective reconciliation below historically authorized B2R15 only with ATTEMPT-003 unfrozen and primary decoding/scoring closed. That B2R15 frontier is superseded by the canonical B2R16 reconciliation below; current execution authority is B2R17 only.
...
At that historical transition, ATTEMPT-001 comparative evidence became ineligible, candidate-superiority claims became unavailable, and no new ATTEMPT-001 primary decoding was authorized. B2R02 has since been separately qualified, merged, and post-merge verified. This historical block grants no present authority.
...
At the B2R13 reconciliation frontier, B2R14 alone was the next bounded unit: qualify the corrected sherpa-onnx result-extraction harness against the canonical deterministic synthetic non-primary fixture and exact pinned upstream source while primary corpus access, ATTEMPT-003 primary evidence access, scoring, ranking, synthesis, production STT selection, and product-code authority remained closed. That B2R13-era instruction is historical and is superseded by the corrective B2R14 reconciliation below; it grants no present execution authority.
## Canonical ATTEMPT-003 B2R14 corrective harness reconciliation

Historical PR #95 merged the original B2R14 candidate as normal merge `2f4212228f24e40fbd03cfc59ab4774df94c0cc3` with first parent `7004199d33c0c60595086636b95537d8fbee3f84` and task head `1687057a56399e5892dee540704b949b868ed94d`. The required fresh independent substantive exact-range review did not complete before that merge; CodeRabbit run `c647c8b6-cd21-4085-b851-523a474d65ce` ended because the PR closed first. Therefore PR #95 and post-merge recovery run `34243679015` remain visible historical chronology but are ineligible as B2R14 task-completion authority.

PR #97 repaired the chronology forward-only without rewriting historical bytes. It requalified the exact B2R14 four-file scope on corrective base `2f4212228f24e40fbd03cfc59ab4774df94c0cc3` and exact qualified head `c60751c43a2523879814d691011d5dd6d3d1e119`. All applicable exact-head CI and the canonical-base trusted `pull_request_target` gate succeeded, fresh independent substantive exact-range review completed with no actionable findings, and zero review threads remained. Guarded normal merge produced `e07e9bf7b7bdff3fdb41cc421140a9d6bdd8b3ca` with first parent `2f4212228f24e40fbd03cfc59ab4774df94c0cc3` and exact qualified head `c60751c43a2523879814d691011d5dd6d3d1e119` as second parent. Exact `main` push run `34246855454` of `000B2 Public Corpus ATTEMPT-003 Recovery` (`workflow_id=352653404`, path `.github/workflows/000b2-public-attempt-003-recovery.yml`) completed successfully on that exact corrective merge SHA.

**Canonical successor recovery predecessor:** `B2R14`
**Canonical B2R14 corrective task base:** `2f4212228f24e40fbd03cfc59ab4774df94c0cc3`
**Canonical B2R14 corrective qualified head:** `c60751c43a2523879814d691011d5dd6d3d1e119`
**Canonical B2R14 corrective task merge:** `e07e9bf7b7bdff3fdb41cc421140a9d6bdd8b3ca`
**Canonical B2R14 corrective post-merge recovery run:** `34246855454`
...
B2R15 is canonically complete after PR #102 merged the exact independently reviewed five-file preexecution-evidence range as guarded normal merge `3d31b18823b8275c99e1478b132a64f36fad05c0` with first parent `ae349f7ef28e8ffd08ee8f54d1727ef80684a31a` and exact qualified head `1410cb81b59de07bdecee6b78e41fdc825f4a55d` as second parent. Fresh independent exact-range CodeRabbit review comment `5591353978` reported no actionable substantive findings before merge. Exact `main` push run `34274935240` of `000B2 Public Corpus ATTEMPT-003 Recovery` (`workflow_id=352653404`, path `.github/workflows/000b2-public-attempt-003-recovery.yml`) completed successfully on that exact merge SHA. The completed task cryptographically rebound ATTEMPT-003 preprocessing and execution-environment evidence to the exact frozen candidate, subset, scorer, normalization, C0, B2R14 harness, source-document, and source-blob identities without primary decoding or scoring.
...
Verified 000A, verified 000B1, canonical B2 entry preparation, canonical B2 authority structure, canonical participant policy/materials, the canonical public-corpus B2 methodology, canonical qualification-chronology remediation, canonical public readiness, canonical B2P01 provenance, canonical B2P02 archive-byte verification, canonical B2P03 deterministic subset selection, canonical B2P04 subset-manifest freeze, and canonical B2P05 candidate revalidation do not weaken this gate.

## Canonical B2R07 recovery reconciliation — predecessor authority

This section records predecessor authority superseded by the canonical B2R08 reconciliation below. PR #74 merged the separately qualified B2R07 implementation and sealed evidence as real task merge `5ea5a513db5ec9c13739510061ca82faa84a0018` from exact final head `704a0998e15562e4b22467b7a99d23de85737e1f` against first parent `16104eacf2d571276452d173ddb54c089faccd0e`. The final eight-file task diff preserved all four reconciliation-authority files and contained no workflow file. Fresh independent exact-range CodeRabbit review on review-only PR #75 reported no actionable substantive correctness, security, evidence-integrity, or governance findings on the exact task head. Exact task-merge push run `34065234517` of `000B2 Public Corpus Attempt Recovery` (`workflow_id=350986920`, path `.github/workflows/000b2-public-attempt-recovery.yml`, job `101572717810`) completed successfully with `head_sha=5ea5a513db5ec9c13739510061ca82faa84a0018`.
...
**Canonical B2R07 recovery merge:** `5ea5a513db5ec9c13739510061ca82faa84a0018`
**Canonical B2R07 post-merge recovery run:** `34065234517`
...
This section records predecessor authority superseded by the canonical B2R09 reconciliation below. PR #78 merged the separately qualified B2R08 implementation and sealed evidence as real task merge `2fb2506f460f54bb5f9ff26889bb92cbf017bf87` from exact final head `a32ccdd4441c8ca6ef04456b28d60c5b29c5e2b8` against first parent `4fc35e9d14f949b90dbee58ddf243a36859e02bd`. The final eight-file task diff preserved all four reconciliation-authority files and contained no workflow file. Fresh independent exact-range CodeRabbit review on review-only PR #79 reported no actionable substantive correctness, security, evidence-integrity, provenance-integrity, fail-closed, or recovery-governance findings on the exact task head. Exact task-merge push run `34153696352` of `000B2 Public Corpus Attempt Recovery` (`workflow_id=350986920`, path `.github/workflows/000b2-public-attempt-recovery.yml`, job `101841001395`) completed successfully with `head_sha=2fb2506f460f54bb5f9ff26889bb92cbf017bf87` and reverified canonical main, all recorded recovery-transition runs, pinned upstream material, and the historical ATTEMPT-001 evidence boundary.
...
**Canonical B2R08 recovery merge:** `2fb2506f460f54bb5f9ff26889bb92cbf017bf87`
**Canonical B2R08 post-merge recovery run:** `34153696352`
...
## Historical B2R09 recovery reconciliation — superseded ATTEMPT-002 authority

This section is historical ATTEMPT-002 transition chronology only and is not current execution authority. At that historical frontier it was the sole current recovery-marker authority in this document. PR #82 merged the separately qualified B2R09 implementation and sealed evidence as real task merge `fc357350270d5cb34fc1305dba4a9de41a5234c3` from exact final head `ff990ccc63a120c62758802c305bcc10b33ed0fe` against first parent `737e2fa0422e0d1aa0dd4d5bdc0473d51cec624c`. The final five-file task diff contains only B2R09 research evidence/decoder/verifier files and no workflow or canonical-authority file. Fresh independent exact-range CodeRabbit review on review-only PR #85 reported no actionable substantive findings on the exact final task head after prior review-only PRs #83 and #84 identified two fail-closed frontier/ledger verifier gaps that were repaired forward-only. Exact task-merge push run `34160146607` of `000B2 Public Corpus Attempt Recovery` (`workflow_id=350986920`, path `.github/workflows/000b2-public-attempt-recovery.yml`, job `101860017509`) completed successfully with `head_sha=fc357350270d5cb34fc1305dba4a9de41a5234c3`.
...
**Historical recovery predecessor:** `B2R09`
**Historical B2R09 recovery merge:** `fc357350270d5cb34fc1305dba4a9de41a5234c3`
...
The following literal marker describes only the superseded B2R09 reconciliation snapshot and is retained so the immutable B2R09 verifier can prove what that historical snapshot said. It is not current execution authority; ATTEMPT-002 is invalidated and the referenced B2R15/B2R16 frontiers are historical and superseded; current recovery authority is ATTEMPT-003 B2R17 only.

```text
**Active recovery unit:** `B2R10`
```

At that historical ATTEMPT-002 frontier, ATTEMPT-001 was historical and ineligible for comparative scoring, ATTEMPT-002 remained frozen with freeze digest `600a286747ef2e1503a48c4138b6e405665ccd6586904ef65b3638b49974bcc8`, `primary_decode_entry_open=true` applied only to B2R10, and B2R10 alone was authorized to execute candidate cell 6 (`sherpa-onnx-balanced`) against the identical frozen P0 public-human audio using the unchanged frozen C0 contract while preserving raw transcripts, failures, runtime observations, exact run identity, frozen input identities, and all claim guards. Those statements are historical only: ATTEMPT-002 is now invalidated for material execution drift and grants no present execution authority. At that historical frontier, execution authority was ATTEMPT-003 B2R15 only, with ATTEMPT-003 unfrozen and primary decoding/scoring closed. That frontier is superseded by the canonical B2R16 reconciliation; current execution authority is ATTEMPT-003 B2R17 only, with ATTEMPT-003 frozen, primary decode entry open only for B2R17, and scoring closed.

## Historical next action at the B2R09 reconciliation — superseded

At that historical frontier, the next action was to qualify `B2R10` only under `000B2-PUBLIC-ATTEMPT-002`. That instruction is now superseded and grants no present execution authority. At that historical frontier, execution authority was exactly B2R15 under ATTEMPT-003, with primary decoding and scoring closed and B2R16+ unauthorized. That frontier is superseded by the canonical B2R16 reconciliation; current execution authority is B2R17 only under frozen ATTEMPT-003, with primary decode entry open only for B2R17 and scoring closed.
...
This section records predecessor authority superseded by the canonical B2R06 reconciliation below. PR #65 merged the separately qualified B2R05 implementation as real task merge `f0ec8b70497769332e1ddc6053e4d32f993b5efc` from exact final head `b1a3f5866fed1eb4df590d134322eb82904cec78` against first parent `9c777ae4f4aaf8387cf54bfa4e8afe80e053ff69`. The final five-file task diff preserved all four reconciliation-authority files, the immutable recovery proof workflow/verifier mechanism, workflows, and ATTEMPT-001 historical bytes. Fresh independent exact-range review on review-only PR #66 reported no actionable substantive findings on the exact task head. Exact task-merge push run `34035710870` of `000B2 Public Corpus Attempt Recovery` (`workflow_id=350986920`, path `.github/workflows/000b2-public-attempt-recovery.yml`) completed successfully with `head_sha=f0ec8b70497769332e1ddc6053e4d32f993b5efc`.
