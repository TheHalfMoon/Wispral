...
At that historical frontier, the next action was to qualify `B2R10` only under `000B2-PUBLIC-ATTEMPT-002`. That instruction is now superseded and grants no present execution authority. Current execution authority is exactly B2R15 under ATTEMPT-003, with primary decoding and scoring closed and B2R16+ unauthorized.
