...
This B2R01 block is retained only as transition chronology and is **not current execution authority**. The later B2R09 block below is also historical/superseded ATTEMPT-002 chronology; the later ATTEMPT-003 B2R14 corrective reconciliation below historically authorized B2R15 only with ATTEMPT-003 unfrozen and primary decoding/scoring closed. That B2R15 frontier is superseded by the canonical B2R15 reconciliation; current execution authority is B2R16 only.
