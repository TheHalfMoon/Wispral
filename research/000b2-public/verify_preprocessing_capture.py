...
def validate_frontier() -> None:
    ...
    require(completed in {"B2P05", "B2P06", "B2P07", "B2P08"}, "B2P06 verifier is valid through the B2P08-reconciled frontier")
