...
def main() -> None:
    ...
    require(readiness.get("completed_through") == "B2P06", "readiness completed_through must be B2P06")
    ...
    for task_id in ALL_TASK_IDS:
        ...
        expected_marker = "- [x]" if task_id in {"B2P01", "B2P02", "B2P03", "B2P04", "B2P05", "B2P06"} else "- [ ]"
