...
B2E02_CANONICAL_MERGE = "91588babc1f738c4284f53d40b4cd96dc13bfd50"
...
def main() -> None:
    ...
    for task_id in ALL_TASK_IDS:
        ...
        expected_marker = "- [x]" if task_id in {"B2P01", "B2P02", "B2P03", "B2P04", "B2P05", "B2P06", "B2P07", "B2P08", "B2E01", "B2E02"} else "- [ ]"
    ...
    require_text(tasks, "- [x] `B2E02` Decode the identical frozen P0 subset with candidate cell 2 under C0.", "public child tasks")
    ...
    require_text(current, B2E02_CANONICAL_MERGE, "current frontier B2E02 canonical proof")
    ...
    require_text(current_state, B2E02_CANONICAL_MERGE, "current state B2E02 canonical proof")
