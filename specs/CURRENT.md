...
This section is retained only as historical ATTEMPT-002 reconciliation chronology and is not current execution authority. It is superseded by the later ATTEMPT-003 successor recovery activation and corrective B2R14 reconciliation, whose B2R15 execution frontier is historical and superseded; current execution authority is B2R16 only. PR #82 merged the separately qualified B2R09 implementation and sealed evidence as real task merge `fc357350270d5cb34fc1305dba4a9de41a5234c3` from exact final head `ff990ccc63a120c62758802c305bcc10b33ed0fe` against first parent `737e2fa0422e0d1aa0dd4d5bdc0473d51cec624c`. The final five-file task diff contains only B2R09 research evidence/decoder/verifier files and no workflow or canonical-authority file. Fresh independent exact-range CodeRabbit review on review-only PR #85 reported no actionable substantive findings on the exact final task head after prior review-only PRs #83 and #84 identified two fail-closed frontier/ledger verifier gaps that were repaired forward-only. Exact task-merge push run `34160146607` of `000B2 Public Corpus Attempt Recovery` (`workflow_id=350986920`, path `.github/workflows/000b2-public-attempt-recovery.yml`, job `101860017509`) completed successfully with `head_sha=fc357350270d5cb34fc1305dba4a9de41a5234c3`.
...
The instruction below is preserved only as historical ATTEMPT-002 chronology and MUST NOT be followed for any new execution decision. At that historical frontier, authority was ATTEMPT-003 B2R15 only, with ATTEMPT-003 unfrozen and primary decoding/scoring closed. That frontier is superseded; current authority is ATTEMPT-003 B2R16 only, with ATTEMPT-003 still unfrozen and primary decoding/scoring still closed.
...
B2R14 has since been corrected forward-only, independently requalified, guarded-normal-merged, and post-merge verified. At that superseded B2R13/B2R14 chronology, the executable frontier advanced to B2R15; that B2R15 frontier is historical and grants no present execution authority. Current executable authority is B2R16 only as recorded in the canonical B2R15 reconciliation below.
