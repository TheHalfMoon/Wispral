...
**Status:** founding research active; ACP verified; B1 historical preregistration verified; public-corpus B2 methodology canonical; qualification-chronology gate `SATISFIED`; public-corpus B2 ATTEMPT-003 recovery active; B2R16 canonical and post-merge verified; active successor recovery unit `B2R17`; ATTEMPT-002 invalidated; ATTEMPT-003 frozen; B2R17 primary decode entry open
...
The following B2R01 block is retained only as transition chronology. It is **not current execution authority**. The latest B2R09 reconciliation block below supersedes its former successor/action state.
...
This section is retained only as historical ATTEMPT-002 reconciliation chronology and is not current execution authority. It is superseded by the later ATTEMPT-003 successor recovery activation and corrective B2R14 reconciliation, whose B2R15/B2R16 execution frontiers are historical and superseded; current execution authority is B2R17 only. PR #82 merged the separately qualified B2R09 implementation and sealed evidence as real task merge `fc357350270d5cb34fc1305dba4a9de41a5234c3` from exact final head `ff990ccc63a120c62758802c305bcc10b33ed0fe` against first parent `737e2fa0422e0d1aa0dd4d5bdc0473d51cec624c`. The final five-file task diff contains only B2R09 research evidence/decoder/verifier files and no workflow or canonical-authority file. Fresh independent exact-range CodeRabbit review on review-only PR #85 reported no actionable substantive findings on the exact final task head after prior review-only PRs #83 and #84 identified two fail-closed frontier/ledger verifier gaps that were repaired forward-only. Exact task-merge push run `34160146607` of `000B2 Public Corpus Attempt Recovery` (`workflow_id=350986920`, path `.github/workflows/000b2-public-attempt-recovery.yml`, job `101860017509`) completed successfully with `head_sha=fc357350270d5cb34fc1305dba4a9de41a5234c3`.
...
## Historical ATTEMPT-002 next action — superseded and non-authoritative

The instruction below is preserved only as historical ATTEMPT-002 chronology and MUST NOT be followed for any new execution decision. At that historical frontier, authority was ATTEMPT-003 B2R15 only, with ATTEMPT-003 unfrozen and primary decoding/scoring closed. That frontier is superseded by the canonical B2R16 reconciliation below; current authority is ATTEMPT-003 B2R17 only, with ATTEMPT-003 frozen, primary decode entry open only for B2R17, and scoring closed.
...
**Historical successor recovery unit at this reconciliation:** `B2R15`
...
B2R14 has since been corrected forward-only, independently requalified, guarded-normal-merged, and post-merge verified. At that superseded B2R13/B2R14 chronology, the executable frontier advanced to B2R15; that B2R15 frontier is historical and grants no present execution authority. That B2R15-era executable authority is historical; current executable authority is B2R17 only as recorded in the canonical B2R16 reconciliation below.

## Canonical ATTEMPT-003 B2R14 corrective harness reconciliation

Historical PR #95 normal merge `2f4212228f24e40fbd03cfc59ab4774df94c0cc3` is preserved but ineligible as B2R14 completion because its required fresh independent substantive review did not complete before merge. Its task base/head were `7004199d33c0c60595086636b95537d8fbee3f84` / `1687057a56399e5892dee540704b949b868ed94d`, and post-merge recovery run `34243679015` does not retroactively satisfy the missing review chronology.

Corrective PR #97 requalified the unchanged B2R14 harness semantics on base `2f4212228f24e40fbd03cfc59ab4774df94c0cc3` and exact qualified head `c60751c43a2523879814d691011d5dd6d3d1e119`. The exact-head CI set, canonical-base trusted `pull_request_target` gate, fresh independent substantive exact-range review, thread reconciliation, and live mergeability gates all completed before guarded normal merge `e07e9bf7b7bdff3fdb41cc421140a9d6bdd8b3ca`. Exact `main` push run `34246855454` of `000B2 Public Corpus ATTEMPT-003 Recovery` succeeded on that merge SHA. The correction had `result_selection_effect=NONE`, used only deterministic synthetic non-primary material, and did not access the primary corpus.
...
At the B2R15 reconciliation frontier, B2R16 alone was the next bounded action. That instruction is historical and is superseded by the canonical B2R16 reconciliation below; it grants no present execution authority.

## Canonical ATTEMPT-003 B2R16 freeze reconciliation

B2R16 is canonically complete at guarded normal merge `885307429ec8b1aa0fe173169a8c2918714c06b0` with first parent `483484023087104a59b239d089da5f749bc8db57` and exact independently reviewed qualified head `ac9f7ce993aec33e6c6436cce4efd85394a97f35` as second parent. Fresh independent exact-range CodeRabbit review comment `5609545905` reported no blocking substantive defect before merge. Exact `main` push run `34415906199` of `000B2 Public Corpus ATTEMPT-003 Recovery` completed successfully on that exact merge SHA. The task froze ATTEMPT-003 before any primary decode with freeze digest `b92d0a88bb50ebde517f560878a26d0ef796abdaf931278f5bc43e372ff1ac8d`.
...
B2R17 alone is the next bounded action: execute candidate cell 1 (`moonshine-compact`) against the identical frozen P0 audio under frozen C0. Preserve raw outputs, failures, runtime observations, exact run identity, frozen input identities, and claim guards. No scoring is authorized. B2R18 and every later successor remain closed. Comparative publication/ranking, production selection, and product-code authority remain closed; `HUMAN_DEVELOPER_SPEECH_ACCURACY_EVIDENCE=ABSENT`, `production_stt_selected=false`, and `product_code_authorized=false` remain preserved.
